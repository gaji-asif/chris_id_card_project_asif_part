...
{{ Form::open(['class' => '', 'files' => true, 'url' => 'update_phase_two_details', 'method' => 'POST', 'enctype' => 'multipart/form-data', 'autocomplete' => 'off']) }}
		...
		<div class="row">
			...
			<div class="form-group">
				...
				<div class="form-group">
					...
					<input type="text" class="form-control" id="total_price" name="total_price" value="{{(int)$patientDetails->total_price}}">
				</div>
			...
			<div class="col-lg-6">
				<div class="form-group row">
					...
					<div class="col-lg-12">
						<input type="text" class="form-control" name="forename" required="required" value="@if(isset($patientDetails)) {{$patientDetails->forename}} @endif">
				...
				<div class="form-group row">
					...
					<div class="col-lg-12">
						<input type="text" class="form-control" name="surname" required="required" value="@if(isset($patientDetails)) {{$patientDetails->surname}} @endif">
				...
				<div class="form-group row">
					...
					<div class="col-lg-12 mt-2">
						<div class="radio radio-inline">
							<label class="mr-4">
								<input type="radio" name="gender" value="male" @if($patientDetails->gender=='male') checked @endif>
								Male
							</label>
							<label>
								<input type="radio" name="gender" value="female" @if($patientDetails->gender=='female') checked @endif>
								Female
							</label>
						</div>
					</div>
				...
				<div class="form-group date">
					<label for="date_of_birth">Date of birth: <span class="required"> (*) </span></label>
					 ...
					 <input type="text" class="form-control" name="date_of_birth" value="@if(isset($patientDetails)) {{$patientDetails->date_of_birth}} @endif">
					
				</div>
				<div class="form-group row">
					<label class="col-lg-6 col-form-label">Email<span class="required" style="color: red;"> (Required *) </span></label>
					<div class="col-lg-12">
						<input type="email" class="form-control" name="email" required="required" value="@if(isset($patientDetails)) {{$patientDetails->email}} @endif">
					</div>
				</div>
				<div class="form-group row">
					<label class="col-lg-6 col-form-label">Mobile<span class="required" style="color: red;"> (Required *) </span></label>
					<div class="col-lg-12">
						<input type="text" class="form-control" name="mobile" required="required" value="@if(isset($patientDetails)) {{$patientDetails->mobile}} @endif">
					</div>
				</div>
				
				<div class="form-group">
					<label for="gp_details"> Address:</label>
					<textarea class="form-control"  name="address" placeholder="address" required="required">
						@if(isset($patientDetails)) {{$patientDetails->address}} @endif
					</textarea>
				</div>
				<div class="form-group row">
				...
				<div class="form-group hide timing_wrap">
					<label for="enter_date">Enter Date: <span class="required"> (*) </span></label>
					 <input type="text" class="form-control" name="enter_date" value="@if(isset($patientDetails)) {{$patientDetails->enter_date}} @endif">
