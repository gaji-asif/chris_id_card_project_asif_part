...
<head>
    ...
    <link rel="stylesheet" href="{{asset('public/web_assets/css/vendor.min.css')}}">
    <link rel="stylesheet" href="{{asset('public/web_assets/css/plugins.min.css')}}">
    <link rel="stylesheet" href="{{asset('public/web_assets/css/style.min.css')}}">
...
<body>
        ...
        <div class="container">
            <div class="row justify-content-between align-items-center">
                <div class="col-md-auto col-12">
                    <p class="text-white text-center text-md-left my-2">Welcome to our Website</p>
                </div>
                <div class="col-auto d-none d-md-block">
                    <div class="topbar-menu">
                        <ul>
                            <li><a href="{{route('registers')}}" class="text-white"><i class="fas fa-user-alt"></i>Sign up</a></li>
                            <li><a href="#" class="text-white"><i class="fas fa-user-alt"></i>login</a></li>
                        </ul>
                    </div>
                </div>
            </div>
            ...
            <div class="row row-cols-lg-3 align-items-center">
                ...
                <div class="col">
                  <div class="header-logo justify-content-center">
                        <a href="#" style="font-family: unset; font-size: 25px;"><!-- <img src="{{asset('public/web_assets/img/logo.png')}}" alt="Learts Logo"> -->
                            COMPANY LOGO
                        </a>
                    </div>
                </div>
            ...
            <div class="row align-items-center">
                ...
                <div class="col d-none d-xl-block">
                    ...
                    <ul>
                        ...
                        <li class="has-children"><a href="#"><span class="menu-text">About Us</span></a>
                        
                        </li>
                        <li class="has-children"><a href="#"><span class="menu-text">Contact Us</span></a>
    ...
    <div class="home1-slider swiper-container">
        <div class="swiper-wrapper">
            <div class="home1-slide-item swiper-slide" data-swiper-autoplay="5000"  data-bg-image="{{asset('public/web_assets/img/slide-1.jpg')}}">
                <div class="home1-slide1-content">
                    <span class="bg"></span>
                    <span class="slide-border"></span>
                    <span class="icon"><img src="{{asset('public/web_assets/img/slide-2-2.png')}}" alt="Slide Icon"></span>
            ...
            <div class="home1-slide-item swiper-slide" data-swiper-autoplay="5000"  data-bg-image="{{asset('public/web_assets/img/slide-3.jpg')}}">
                <div class="home1-slide3-content">
                    <h2 class="title">Affectious gifts</h2>
                    <h3 class="sub-title">
                        <img class="left-icon " src="{{asset('public/web_assets/img/slide-2-2.png')}}" alt="Slide Icon">
                        For friends & family
                        <img class="right-icon "  src="{{asset('public/web_assets/img/slide-2-3.png')}}" alt="Slide Icon">
                    </h3>
                    <div class="link"><a href="#">shop now</a></div>
                </div>
            </div>
        </div>
        <div class="home1-slider-prev swiper-button-prev"><i class="fas fa-arrow-right"></i></div>
        <div class="home1-slider-next swiper-button-next"><i class="fas fa-arrow-right"></i></div>
    </div>
    ...
    <div class="section section-padding pb-20">
        <div class="container">
            <div class="row learts-mb-n30">
                ...
                <div class="col-md-6 col-12 text-center learts-mb-30">
                    <img src="{{asset('public/web_assets/img/about-5.jpg')}}" alt="">
                </div>
        ...
        <div class="container">
            <div class="row text-center row-cols-1">
                ...
                <div class="footer1-copyright col">
                    <p class="copyright">&copy; 2020 . All Rights Reserved | <strong>(+00) 123 567990</strong> | <a href="#">info@company.com</a></p>
                </div>
...
<script src="assets/js/plugins/scrollax.min.js"></script> -->
    ...
    <!-- Use the minified version files listed below for better performance and remove the files listed above -->
    <script  src="{{asset('public/web_assets/js/vendor.min.js')}}"></script>
    <script  src="{{asset('public/web_assets/js/plugins.min.js')}}"></script>
