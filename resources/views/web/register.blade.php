...
<body>
    ...
    <div class="register_wrapper">
        <div class="row">
            ...
            <div class="col-lg-6">
                <div class="user-login-register bg-light mt-5 mb-5 pb-5 pt-5">
                ...
                <div class="login-register-form">
                    <form action="#">
                        ...
                        <div class="col-12 learts-mb-50">
                            <div class="col-auto learts-mb-20" style="float: left;"><a href="#" class="btn btn-primary">As a Customer</a></div>

                            <div class="col-auto learts-mb-20" style="float: left;"><a href="#" class="btn btn-primary2">As a Retailer</a></div>
                        </div>
                            <div class="col-12 learts-mb-50">
